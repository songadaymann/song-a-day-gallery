    ...
    !function(t, e) {
      ...
      function n(t2, e2) {
        ...
        var r2, n2, a2 = function(t3, e3) {
          ...
          for (n3 = 0; n3 < o3.length; n3++) r3 = o3[n3], e3.indexOf(r3) >= 0 || (a3[r3] = t3[r3]);
          return a3;
        }(t2, e2);
        if (Object.getOwnPropertySymbols) {
          var o2 = Object.getOwnPropertySymbols(t2);
          for (n2 = 0; n2 < o2.length; n2++) r2 = o2[n2], e2.indexOf(r2) >= 0 || Object.prototype.propertyIsEnumerable.call(t2, r2) && (a2[r2] = t2[r2]);
        }
        return a2;
      }
      function a(t2, e2) {
        return function(t3) {
          ...
          if (!(Symbol.iterator in Object(t3) || "[object Arguments]" === Object.prototype.toString.call(t3))) return;
      ...
      function o(t2) {
        return function(t3) {
          if (Array.isArray(t3)) {
            for (var e2 = 0, r2 = new Array(t3.length); e2 < t3.length; e2++) r2[e2] = t3[e2];
            return r2;
          }
        }(t2) || function(t3) {
      ...
      function s() {
        ...
        return { get: function(r2, n2) {
          ...
          if (o2 in e2) return Promise.resolve(t2.serializable ? JSON.parse(e2[o2]) : e2[o2]);
      ...
      function p(t2) {
        for (var e2 = arguments.length, r2 = new Array(e2 > 1 ? e2 - 1 : 0), n2 = 1; n2 < e2; n2++) r2[n2 - 1] = arguments[n2];
        var a2 = 0;
      ...
      function S(t2, e2, n2, a2) {
        var i2 = [], u2 = function(t3, e3) {
          if (t3.method === x || void 0 === t3.data && void 0 === e3.data) return;
          ...
          var f3 = r2.pop();
          if (void 0 === f3) throw { name: "RetryError", message: "Unreachable hosts - your application id may be incorrect. If the error persists, please reach out to the Algolia Support team: https://alg.li/support .", transporterStackTrace: E(i2) };
      ...
      function k(t2) {
        var e2 = t2.hostsCache, r2 = t2.logger, n2 = t2.requester, o2 = t2.requestsCache, i2 = t2.responsesCache, u2 = t2.timeouts, s2 = t2.userAgent, c2 = t2.hosts, f2 = t2.queryParameters, d2 = { hostsCache: e2, logger: r2, requester: n2, requestsCache: o2, responsesCache: i2, timeouts: u2, userAgent: s2, headers: t2.headers, queryParameters: f2, hosts: c2.map(function(t3) {
          ...
          if (true !== (void 0 !== r3.cacheable ? r3.cacheable : t3.cacheable)) return n3();
      ...
      function B(t2) {
        return function e2(r2) {
          return t2.request(r2).then(function(n2) {
            if (void 0 !== t2.batch && t2.batch(n2.hits), !t2.shouldStop(n2)) return n2.cursor ? e2({ cursor: n2.cursor }) : e2({ page: (r2.page || 0) + 1 });
          });
        }({});
      }
      var K = function(t2) {
          ...
          return function n2() {
            return ie(t2)(u2 || "", r(r({}, c2), {}, { page: f2 })).then(function(t3) {
              for (var r2 = 0, o3 = Object.entries(t3.hits); r2 < o3.length; r2++) {
                ...
                if (e2(c3)) return { object: c3, position: parseInt(u3, 10), page: f2 };
              }
              if (f2++, false === s2 || f2 >= t3.nbPages) throw { name: "ObjectNotFoundError", message: "Object not found." };
              return n2();
            });
          }();
        };
        ...
        return function(t2, e2) {
          for (var r2 = 0, n2 = Object.entries(t2.hits); r2 < n2.length; r2++) {
            ...
            if (o2[1].objectID === e2) return parseInt(i2, 10);
          }
          return -1;
        };
      }, Lt = function(t2) {
      ...
      function xe(t2, e2, n2) {
        ...
        } }), responsesCache: s(), requestsCache: s({ serializable: false }), hostsCache: u({ caches: [i({ key: "".concat("4.24.0", "-").concat(t2) }), s()] }), userAgent: T("4.24.0").add({ segment: "Browser" }) }, f2 = r(r({}, o2), n2), d2 = function() {
          return function(t3) {
            return function(t4) {
